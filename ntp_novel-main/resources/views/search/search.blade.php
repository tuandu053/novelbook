...
<div class="col-md-12 mt-3 mb-5">
    <form class="" method="POST" action="{{ route('Novel.page_tim_kiem') }}">
        ...
        <div class="d-flex">
            ...
            <button class="btn btn-outline-success w-25" type="submit"><i class="fa-solid fa-magnifying-glass"></i> Tìm kiếm</button>
        </div>
        ...
        @if (isset($ispage_timkiem) && $ispage_timkiem)
            ...
            <div class="d-flex mt-3 gap-3">
                <span class="flex-shrink-0">Thể loại</span>
