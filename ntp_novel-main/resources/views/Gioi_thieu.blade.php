        ...
        <div class="row justify-content-center">
            <ol>
                ...
                <li><strong>Đề t&agrave;i</strong>
                    <ul>
                        <li>
                            <p>Đề t&agrave;i X&acirc;y dựng v&agrave; kiểm thử website đọc tiểu thuyết TNP-Novel thuộc lĩnh
                        ...
                        <li>
                            <p>Ngo&agrave;i ra c&ograve;n c&oacute; c&aacute;c vấn đề về kiểm duyệt nội dung, vấn đề về an
                                ...
                                X&acirc;y dựng v&agrave; kiểm thử website đọc tiểu thuyết TNP-Novel.</p>
                        </li>
                    </ul>
                </li>
